...
$config = [
    ...
    'components' => [
        ...
        'urlManager' => [
            'hostInfo' => YII_DEBUG ? 'http://yii2-template-simple' : 'http://yii2-template-simple',
            'scriptUrl' => YII_DEBUG ? 'http://yii2-template-simple' : 'http://yii2-template-simple',
        ],
        'cache' => [
    ...
    'controllerMap' => [
        'sitemap' => [
            ...
            'baseUrl' => YII_DEBUG ? 'http://yii2-template-simple' : 'http://yii2-template-simple',
