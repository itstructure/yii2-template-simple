<?php
use app\models\{About, Technology, Quality, User, Home, Contact};
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                <h2 class="text-center"><?php echo $about->title; ?></h2>
                        ...
                        <div class="team-wrapper">
                            ...
                            <div class="team-des">
                                ...
                                <?php if (!empty($user->position)): ?>
                                    <div class="team-position"><?php echo $user->position->name; ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
