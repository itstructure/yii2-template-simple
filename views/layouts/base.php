...
<div class="wrap">
    ...
    <ul class="nav navbar-nav navbar-right">
        <li class="nav-item <?php if($controllerId=='home'): ?>active<?php endif; ?>">
            <a class="nav-link" href="/"><?php echo Yii::t('app', 'Home') ?></a>
        </li>
        <li class="nav-item <?php if($controllerId=='about'): ?>active<?php endif; ?>">
            <a class="nav-link" href="/about"><?php echo Yii::t('about', 'About') ?></a>
        </li>
        ...
        <li class="nav-item <?php if($controllerId=='contact'): ?>active<?php endif; ?>">
            <a class="nav-link" href="/contact" ><?php echo Yii::t('contacts', 'Contacts') ?></a>
        </li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li class="dropdown-item">
                        <a href="/reg" ><?php echo Yii::t('site', 'Register') ?></a>
                    </li>
                    <li class="dropdown-item">
                        <a href="/login" ><?php echo Yii::t('site', 'Login') ?></a>
                    </li>
                </ul>
            </li>
        <?php else: ?>
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li class="dropdown-item">
                        <a href="/admin" ><?php echo Yii::t('site', 'Dashboard') ?></a>
                    </li>
                    <li class="dropdown-item">
                        <a href="/logout" ><?php echo Yii::t('site', 'Sign out') ?></a>
                    </li>
                </ul>
            </li>
        <?php endif; ?>
...
<footer class="footer">
            ...
            <div class="col-lg-7 col-md-8 col-sm-8 padbot30">
                <ul class="foot_menu">
                    <li <?php if($controllerId=='home'): ?>class="active"<?php endif; ?> >
                        <a href="/" alt=""><?php echo Yii::t('app', 'Home') ?></a>
                    </li>
                    <li <?php if($controllerId=='about'): ?>class="active"<?php endif; ?> >
                        <a href="/about" ><?php echo Yii::t('about', 'About me') ?></a>
                    </li>
                    <li <?php if($controllerId=='contact'): ?>class="active"<?php endif; ?> >
                        <a href="/contact" ><?php echo Yii::t('contacts', 'Contacts') ?></a>
                    </li>
                </ul>
                <hr>
                <?php if (null !== $contacts): ?>
                    <ul class="foot_info">
                        <?php if (!empty($contacts->address)): ?>
                            <li><i class="fa fa-home"></i><?php echo $contacts->address ?></li>
                        <?php endif; ?>
                        <?php if (!empty($contacts->phone)): ?>
                            <li><i class="fa fa-phone"></i><?php echo $contacts->phone ?></li>
                        <?php endif; ?>
                        <?php if (!empty($contacts->email)): ?>
                            <li><i class="fa fa-envelope-o"></i><a href="mailto:<?php echo $contacts->email ?>"><?php echo $contacts->email ?></a></li>
                        <?php endif; ?>
                    </ul>
                <?php endif; ?>
            </div>
    ...
    <div class="copyright clearfix">
        <div class="container">
            <div class="padbot20">
                <a class="copyright_logo" href="javascript:void(0);"><?php echo Yii::t('app', 'Yii2 project simple template') ?></a> <span> &copy; Copyright <?php echo date('Y') ?></span>
            </div>
        </div>
    </div>
</footer>
